...
func Update(idUser string, id string, ModelType string, owner string, Accuracy string) ([]byte, error) {
	...
	result, err := contract.SubmitTransaction("UpdateAsset", id, ModelType, owner, Accuracy)
	if err != nil {
