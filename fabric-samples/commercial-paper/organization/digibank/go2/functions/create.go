...
func Create(idUser string, cid string, ModelType string, owner string, Accuracy string) ([]byte, error) {
	...
	defer log.Printf("==============> CreateAsset %v program complete", cid)
	defer gw.Close()
	...
	result, err := contract.SubmitTransaction("CreateAsset", cid, ModelType, owner, Accuracy)
	if err != nil {
